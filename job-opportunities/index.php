                        ...
                        <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
                            <ul class="navbar-nav  ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="../call-for-papers/index.php">Call For
                                            Papers</a>
                                        <a class="dropdown-item" href="../paper-submission/index.php">Paper
                                            Submission</a>
                                        <a class="dropdown-item" href="../important-dates/index.php">Important
                                            Dates</a>
                                ...
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="../student-paper-award/index.php">Student Paper
                                            Award</a>
                                        <a class="dropdown-item" href="../b.tech_m.tech-student-connect">B.Tech / M.Tech
                                            Student
                                            Connect Initiative Program</a>
                                        <a class="dropdown-item" href="../student-opportunities/index.php">Opportunities
                                            for Students</a>
                                        <a class="dropdown-item active" href="../student-opportunities/index.php">Job
                                            Opportunities</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="https://forms.gle/FgXKFrPKpeaYxzFd7">Chapter
                                            Chair Meeting</a>
                                        <a class="dropdown-item" href="../startup-initiative.php">Startup
                                            Initiative</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
        ...
        <div class="container">
            ...
            <div class="cfa_heading">
                <p style="text-align: justify;">
                    ...
                    providing a single consolidated page containing valuable information for students and Young
            ...
            <center>
                <a href="https://docs.google.com/forms/d/1jbUCUGom-mJwZ94dwxsDOpvWNjBYBN9TOE-7olFUp2Q" style="border: 1px solid #ffffff;

        ...
        <div class="col-md-12">
          <div class="detail-box">
            <div class="heading_container spon_padding">
              <h2>
                Level of <span>Sponsorships</span>
              </h2>
            </div>
            <div class="spon_body">
            ...
            <div class="spon_body">
              <h2><span>Diamond</span> Sponsor: <u>INR 10.0L</u> (US$13.5K) + GST (18%)</h2>
              <p>
              <ul>
            ...
            <div class="spon_body">
              <h2><span>Platinum</span> Sponsor: <u>INR 8.0L</u> (US$10.8K) + GST (18%)</h2>
              <p>
              <ul>
            ...
            <div class="spon_body">
              <h2><span>Gold</span> Sponsor: <u>INR 6.0L</u> (US$ 8.1K) + GST (18%)</h2>
              <p>
              <ul>
            ...
            <div class="spon_body">
              <h2><span>Silver</span> Sponsor: <u>INR 4.0L</u> (US$5.4K) + GST (18%)</h2>
              <p>
              <ul>
                <li>4 Complimentary delegate passes</li>
            ...
            <div class="spon_body">
              <h2><span>Bronze</span> Sponsor: <u>INR 2.0L</u> (US$2.7K) + GST (18%)</h2>
              <p>
              <ul>

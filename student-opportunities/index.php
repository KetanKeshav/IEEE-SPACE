              ...
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="../b.tech_m.tech-student-connect">B.Tech / M.Tech Student
                      Connect Initiative Program</a>
                    <a class="dropdown-item active" href="../student-opportunities/index.php">Opportunities for
                      Students</a>

              ...
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item active" href="../paper-submission/index.php">Paper Submission</a>
    ...
    <section class="course_section layout_padding content-bg">
      <div class="container">
        <div class="heading_container heading_center">
          <h2>
            GUIDELINES TO <span>AUTHORS</span>
          </h2>
        </div>
        ...
        <div class="spon_body">
          ...
          <p>
            ...
            format of A4 size in English. Papers must be three to upto six pages in length, including texts,

                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="../phd-student-initiative/index.php">PhD Student Initiative
                      Program</a>
                    <a class="dropdown-item active" href="../student-paper-award/index.php">Student Paper Award</a>
  ...
  <div class="content_bg">
    ...
    <section class="course_section layout_padding content-bg">
      <div class="container">
        ...
        <div class="spon_body">
          <h2>MAPCON Best Student Paper Award - <span>1<sup>st</sup></span> - INR 10,000</h2>
          <h2>MAPCON Best Student Paper Award - <span>2<sup>nd</sup></span> - INR 5,000</h2>
          <p>

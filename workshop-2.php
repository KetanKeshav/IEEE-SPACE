                            ...
                            <ul class="navbar-nav  ">
                                ...
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item active" href="../workshop-2.php">Workshop-2</a>
    ...
    <section class="course_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                ...
                <h2>Date: Dec 12, 2022, 8.30-17.30 Hall: Varuna</h2>
                    ...
                    <table class="table table-bordered border-primary text-justify">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>What is a Spectrum Analyzer?</li>
                                        <li>Prerequisite Basic Fundamentals</li>
                                        <li>Main platform types of Spectrum and Signal Analysers</li>
                                        <li>Main functional blocks and related roles in the Spectrum Analyzer</li>
                                        <li>Input Attenuator, Preamplifier, Low Pass Filter</li>
                                        <li>Local Oscillator, Mixer, Resolution BW and Video BW</li>
                                        <li>Signal Detection, Trace types</li>
                                        <li>Main functions/measurements of a Spectrum Analyzer</li>
                                        <li>Frequency Domain: Channel Power, Occupied Bandwidth, ACPR</li>
                                        <li>Time Domain (Zero SPAN), Limits, Spectrogram</li>
                                        <li>Real Time Spectrum Analyzer</li>
                                        <li>Practical Applications: Measurement of unknown signals, Analog Modulation,
                                            Digital Modulations & 5G NR and LTE</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    Fundamentals of Vector Network Analyzer & Characterization of antenna using VNA
                                </td>
                                <td>
                                    Basics of Transmission Line
                                    <ul>
                                        <li>VNA for Passive and Active device</li>
                                        <li>VNA Architecture</li>
                            ...
                            <tr>
                                ...
                                <td>
                                    Fundamentals of Power Meter
                                </td>
                                <td>
                                    Power Meter and it's function
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Basic of 5G and Testing requirements</td>
                                <td>
                                    5G Generation and Testing
                                </td>
                            </tr>
                        </tbody>
                    </table>

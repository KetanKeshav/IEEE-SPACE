...
<head>
    ...
    <title>Prof. Pathak Lectures | SPACE 2024</title>
        ...
        <div class="container">
            <div class="heading_container heading_center">
                <h2 style="text-align: center;">
                    <span>Prof. Pathak</span> Lectures
                </h2><br>
            </div>

            <iframe src="../downloads/MAPCONTUTORIAL.pdf" frameborder="0" style="width:100%;" height="750"></iframe>
        </div>
    </section>

...
<head>
    ...
    <title>Banequet TED Talks | SPACE 2025</title>
        ...
        <div class="container">
            <div class="heading_container heading_center">
                <h2 style="text-align: center;">
                    Challenges and Opportunities of Decarbonization in the <span>Global Electric Power Sector</span>
                </h2><br>
                <h3>
                    Saifur Rahman, 2023 IEEE President & CEO and Professor, Director, Virginia Tech, USA
                </h3>
                <div class="container  ">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="heading_container heading_center">
                <h2 style="text-align: center;">
                    <span>Engineering Indian space program</span>
                </h2><br>
                <h3>
                    Dr. M Annadurai, Former Director, URSC/ISRO and Vice President, Tamil Nadu State Council for Science and Technology
                </h3>
                <div class="container  ">
                    <div class="row">
                        <div class="col-md-12">

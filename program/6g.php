        ...
        <div class="container">
            <div class="heading_container heading_center">
                <h2 style="text-align: center;">
                    Special Session on <span>6G</span>
                </h2><br>
                <div class="container  ">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="detail-box">
                                ...
                                <ul style="text-align: left;">
                                    <li>Dr. Tushar Sharma, Renesas USA, "Shaping the 5G and Beyond Ecosystem in India"</li>
                                    <li>Dr. Kiran Mukkavilli, Qualcomm USA, "Technology Enablers and Roadmap to 6G"</li>
                                </ul>
                                <div class="heading_container spon_padding">
                                    <h2>
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Dr. Aloknath De, Samsung</td>
                                            </tr>
                                            <tr>
                                                <th scope="row" rowspan="4">Panelists</th>
                                                <td>Dr. Tushar Sharma, Renesas</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Kiran Mukkavilli, Qualcomm</td>
                                            </tr>
                                            <tr>
                                                <td>Mr. Santhosh Kumar, TI</td>
                                            </tr>
                                            <tr>
                                                <td>Mr. Akshay Aggarwal, MediaTek</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>

...
<head>
    ...
    <title>YP Activities | SPACE 2024</title>
    ...
    <section class="course_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                ...
                Panel Discussion on <span>"Future of RF and Microwave Research in India: Towards Stronger Collaboration Between Academia and Industry"
</span>
                </h2><br>
                <div class="container  ">
                    <div class="row">
                                    ...
                                    <table class="table table-hover" style="text-align: left;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Dr. Debdeep Sarkar, IISc Bangalore</td>
                                            </tr>
                                            <tr>
                                            <th scope="row" rowspan="7">Panelists</th>
                                                <td>Dr. Soumava Mukherjee, IIT Jodhpur</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. G. Shrikanth Reddy, IIT Mandi</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Situ Rani Patre, NIT Rourkela</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Shiv Narayan, CSIR-NAL</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Venkata Vanukuru, Global Foundries</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Rajesh Chivkula, Honeywell Pvt. Ltd.</td>
                                            </tr>
                                            <tr>
                                                <td>Dr. Somak Bhattacharyya, IIT (BHU), Varanasi</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>

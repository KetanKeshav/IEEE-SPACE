...
<head>
    ...
    <title>Special Session on Array Antennas | SPACE 2024</title>
        ...
        <div class="container">
            <div class="heading_container heading_center">
                <h2 style="text-align: center;">
                    Special Session on <span>Array Antennas</span> (Session Chair: Prof. Prabhakar Pathak, OSU, USA)
                </h2><br>
                <div class="container  ">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="detail-box">
                                <div class="heading_container spon_padding">
                                    <h2>
                                        <span>Near-Field Focused Antenna Arrays for Short Range Communications and Wireless Power Transfer, Prof. Giuliano Manara, Dipartimento di Ingegneria dell’Informazione, University of Pisa, Pisa, ITALY</span>
                                    </h2>
                                </div>
                                ...
                                <div class="heading_container spon_padding">
                                    <h2>
                                        <span>Dynamic Beam Forming and Modulation using a Reconfigurable Metasurface, KJ Vinoy, Aritra Roy, Gouranga Dhaundia, Electrical Communication Engineering, Indian Institute of Science, Bengaluru</span>
                                    </h2>
                                </div>
                                <p style="text-align: justify;">
                                ...
                                <div class="heading_container spon_padding">
                                    <h2>
                                        <span>Antenna-Platform Interaction Study in Phased Array Antennas, Dr.Ashutosh Kedar, LRDE/DRDO</span>
                                    </h2>
                                </div>
                                <p style="text-align: justify;">

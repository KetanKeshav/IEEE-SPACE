...
<head>
    ...
    <title>AP-S & MTT-S SIGHT Activities | SPACE 2024</title>
        ...
        <div class="container">
            <div class="heading_container heading_center">
                <div class="container  ">
                    <div class="row">
                        <div class="col-md-12">
                            <img class="img-fluid" src="./images/program-1.jpg" alt="panel">
                        </div>
                        <div class="col-md-12">
                            <img class="img-fluid" src="./images/program-2.jpg" alt="panel">
                        </div>
                    </div>
                </div>
            </div>

...
<body>
  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      ...
      Access 2024 IEEE SPACE papers <a href="https://ieeexplore.ieee.org/xpl/conhome/10666970/proceeding" style="color: white;">Click Here</a> &nbsp;&nbsp;&nbsp;&nbsp; Last date for Paper Submission: 21st March, 2025 <a href="https://edas.info/N33216" style="color: white;">Click Here</a>
      </marquee>
...
<center>
<div class="detail_box">
    <a href="https://edas.info/N33216" class="button-con" style="width:300px; height:70px; text-align:center; display:inline-block; margin-right:10px;">
        <h1>Submit Paper</h1>
    </a>
    <a href="downloads/SPACE 2025 CFP.pdf" class="button-con" style="width:300px; height:70px; text-align:center; display:inline-block;" download>
        <h1>Download CPF</h1>
    </a>
</div>
                    </center>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            With its focus on IEEE Tagline "Advancing Technology for Humanity" and pushing the boundaries of SPACE, aerospace and defence capabilities,  SPACE plays a crucial role in shaping the future of these industries. By bringing together thought leaders and experts, the conference serves as a catalyst for driving progress and innovation in the space, aerospace and defence sectors, ultimately contributing to advancing Indian & Global  capabilities in these domains.
  ...
  <!-- Venue Details-->
  <!-- <section class="about layout_padding" id="venue">
    <div class="container  ">
      <div class="row">
        <div class="col-md-6 ">
        <div class="heading_container">
